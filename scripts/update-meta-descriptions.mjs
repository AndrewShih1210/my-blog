...
const descriptions = {
  ...
  "03-Enhancing-learning-outcomes-and-reducing-anxiety-in-programming-courses-through-AI-integration/index_en.html": "This study evaluates the effects of AI integration in programming courses on learning outcomes and anxiety, particularly for students without a computing background.",
  ...
  "05-優化學習工作流輕量級無伺服器AI代理人之開發與成效分析/index.html": "介紹用於優化學習工作流的輕量級無伺服器 AI 代理人，分析其系統設計、任務自動化流程與實施成效，說明低維護部署在教育情境中的使用方式與限制。",
  ...
  "06-優化教學場域與學習效率之輕量級無伺服器AI代理人應用/index_en.html": "This research applies a lightweight serverless AI agent to teaching contexts and examines information retrieval, content generation, records, notifications, and their relationship with teaching and learning efficiency.",
  ...
  "10-生成式AI自動評分與回饋系統之滿意度與需求分析/index.html": "分析大學生使用生成式 AI 自動評分與回饋系統的滿意度、接受情形及功能需求，檢視系統對教師工作量與個人化學習指引的影響。",
